...
public class Config {
	...
	public static final String scoreboard_id = "jp.vfja.android.CalcMax4.highscore";

	// Register depend on App
	public static final String _MEDIA_CODE = "jp.vfja.android.1vBT";

	// high score local file
	public static final String score_file_save = "highScore.dat";
	
	public static final int NEND_ADV_ID = 49047;
	public static final String NEND_ADV_API_KEY = "b6078f11d8e2776ed56aee23029b0f096914cfaa";
