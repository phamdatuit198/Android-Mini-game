...
public class TopActivity extends SuperActivity {
	...
	protected void onStart() {
		...
		super.onStart();
		Common.trackView(this, Config.TOP_SCREEN);
	}
	@Override
	...
	protected void initContentLayout() {
		...
		btnStart = new ButtonView2Status(mContext, Config.TOP_START1_X,Config.TOP_START_Y, Config.TOP_BUTTON_HEIGHT,
				Config.TOP_BUTTON_WIDTH, Config.TOP_BUTTON_PLAY, Config.TOP_BUTTON_PLAY_SWEEL);
		
		btnRanking = new ButtonView2Status(mContext, Config.TOP_START1_X,Config.TOP_RANKING_Y, Config.TOP_BUTTON_HEIGHT,
				Config.TOP_BUTTON_WIDTH, Config.TOP_BUTTON_RANKIN,Config.TOP_BUTTON_RANKIN_SWEEL);
		
		btnManual = new ButtonView2Status(mContext, Config.TOP_START2_X,Config.TOP_MANUAL_Y, Config.TOP_BUTTON_HEIGHT,
				Config.TOP_BUTTON_WIDTH, Config.TOP_BUTTON_MANUAL, Config.TOP_BUTTON_MANUAL_SWEEL);
		
		btnInfo = new ButtonView2Status(mContext, Config.TOP_START2_X,Config.TOP_INFO_Y, Config.TOP_BUTTON_HEIGHT,
				Config.TOP_BUTTON_WIDTH, Config.TOP_BUTTON_INFO,Config.TOP_BUTTON_INFO_SWEEL);
		
		btnVitalify = new ButtonView2Status(mContext, Config.TOP_START3_X,Config.TOP_VFA_Y, Config.TOP_BUTTON_HEIGHT,
				Config.TOP_BUTTON_WIDTH_VFA, Config.TOP_BUTTON_VFA,Config.TOP_BUTTON_VFA_SWEEL);
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_UP:
					if(btnStart.isOnSize(x, y)){
						btnStart.setTouched(false);
						//set move here
						Intent intent = new Intent(mContext, HomeRun.class);
