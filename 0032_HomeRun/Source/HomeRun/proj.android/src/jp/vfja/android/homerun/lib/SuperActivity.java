package jp.vfja.android.homerun.lib;
...
//		}
	 ...
	 */
	public void initView(boolean isScreenTop) {

//		mMiddleBackground = new ImageManual(mContext, 10,
//				(Config.SCREEN_HEIGHT - 736 * Config.ratioX) / 2,
//				736 * Config.ratioX, Config.SCREEN_WIDTH -20,
//				Config.TOP_BACKGROUND_MIDDLE);
		if(isScreenTop){
			mbackground = new ImageManual(mContext, 0, 0, Config.SCREEN_HEIGHT,
					Config.SCREEN_WIDTH, Config.TOP_COMMON_BACKGROUND2);
			parent.addView(mbackground);
		}else{
			mbackground = new ImageManual(mContext, 0, 0, Config.SCREEN_HEIGHT,
	...
	public void initManue(){
		mbackground = new ImageManual(mContext, 0, 0, Config.SCREEN_HEIGHT,
				Config.SCREEN_WIDTH, Config.MANUAL_BACKGROUND);
		parent.addView(mbackground);
