...
public class InfoActivity extends Activity {
	...
	private ImageManual mBackground;
	...
	private void initResource() {
		...
		mBackground = new ImageManual(mContext, backgroundPos.x, backgroundPos.y, Config.TOP_LOGO_HEIGHT, Config.TOP_LOGO_WIDTH, Config.INFO_BACKGROUND);
