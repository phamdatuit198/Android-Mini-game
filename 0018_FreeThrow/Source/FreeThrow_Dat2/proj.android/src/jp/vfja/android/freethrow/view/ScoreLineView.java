package jp.vfja.android.freethrow.view;
...
public class ScoreLineView extends View {
	...
	public ScoreLineView(Context context, float x, float y, float height, float width, String title, Bitmap bitmap) {
		super(context);
		this.x = x;
		this.y = y;
		this.height = height;
	...
	public ScoreLineView(Context context, float x, float y, float height,float width, String title, Typeface font, float size) {
		super(context);
		this.x = x;
		this.y = y;
		this.height = height;
