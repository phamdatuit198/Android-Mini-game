...
public class Config {
	...
	public static final String scoreboard_id = "jp.vfja.android.freethrow.highscore";

	// Register depend on App
	public static final String _MEDIA_CODE = "jp.vfja.android.8EdK";

	// high score local file
	public static final String score_file_save = "highScore.dat";
	
	public static final int NEND_ADV_ID = 52021;
	public static final String NEND_ADV_API_KEY = "8b76fce323600fbec3d3c1ec19963fe0980e63e3";
