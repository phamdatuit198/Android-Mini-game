...
public class SplashActivity extends Activity {
	...
	private void initResource() {
		...
		initScreenSize();
		// init font
		Config.fontRanking = Typeface.createFromAsset(mContext.getAssets(), "HGRPP1_0.ttf");
	...
	private void moveToTop() {
		CountDownTimer countDownTimer = new CountDownTimer(5000, 5000) {
			public void onTick(long millisUntilFinished) {
				Toast.makeText(mContext, "" + millisUntilFinished,
	...
	private void initScreenSize() {
		logoPos = new Point(0,
				(Config.SCREEN_HEIGHT - Config.TOP_LOGO_HEIGHT) / 2);
		mLogo = new Image(mContext, logoPos.x, logoPos.y,
				Config.TOP_LOGO_HEIGHT, Config.TOP_LOGO_WIDTH,
				Config.SPLASH_LOGO);
	}
